		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				<div class="logo margin-top-30">
                                    <b><h1>  <b>HospDBMS | New Doctor </b>  </h1></b>
				</div>
                            
                            <br>

				<div class="box-login"  style="border: 7px solid lightcyan  ; padding: 12px; border-radius: 9px 9px; ">
					<form class="form-login" method="post" action="SignupController.jsp">
						<fieldset>
							<legend>
								Create an account
							</legend>
							...
							<div class="form-group form-actions">
								<span class="input-icon">
									...
									<i class="fa fa-lock"></i>
                                                       ...
                                                       <div class="form-group form-actions">
								<span class="input-icon">
									<input type="password" class="form-control password" name="cpassword" placeholder="Confirm Password">
									<i class="fa fa-lock"></i>
									 </span>
							</div>
                                                        ...
                                                        <div class="form-group form-actions">
								<span class="input-icon">
									<input type="tel" class="form-control password" name="number" placeholder="Mobile Number">
									<i class="fa fa-phone"></i>
                                                         ...
                                                         <div class="form-group form-actions">
								<span class="input-icon">
                                                                    <select name="dspec" class="form-control" required="required" style="padding-left: 30px;">
